<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div class="px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex justify-between h-16">
            ...
            <!-- Hamburger -->
            <div class=" z-10 z-mr-2 flex items-center sm:hidden">
                <button @click="open = ! open"
                    class=" z-10 inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 focus:text-gray-500 transition duration-150 ease-in-out">
