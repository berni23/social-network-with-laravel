   <!-- Modal accept friendship request -->
   ...
   <div id="modalAccept"
       ...
       <div class="modal-container bg-white w-11/12 md:max-w-md mx-auto rounded shadow-lg z-50 overflow-y-auto">
           ...
           <h3 class="flex justify-center text-lg leading-6 font-medium text-gray-900" id="modal-headline">
               {{ $username }} sent you a friendship request
           </h3>
           <br><br>
           <form id="form-accept" method="POST" action='/user/respond/{{ $respond_id }}'
               class="modal-content py-4 text-left px-6">
               @csrf
               <div class="flex justify-center pt-2justify">
                   <input class='hidden' name="relStatus" value='{{ $relStatus }}'>
                   <input type="submit" name="confirm" id="accept-confirm"
                       class="modal-close px-4 bg-green-400 p-3 focus:outline-none rounded-lg text-white-500 hover:bg-gray-100 hover:text-indigo-400 mr-2"
                       value="accept">
